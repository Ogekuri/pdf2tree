...
if [ -n "$GEMINI_API_KEY" ]; then
    ...
    echo "./pdf2tree.sh --from-file pdf_sample/pdf_sample.pdf --to-dir temp/pdf_sample_test/ --verbose --debug --header 8 --footer 10"
    ./pdf2tree.sh --from-file pdf_sample/pdf_sample.pdf --to-dir temp/pdf_sample_test/ --verbose --debug --header 8 --footer 10
else
